...
"%":"Blob|CanvasGradient|CanvasPattern|DOMError|File|FileError|MediaError|MediaKeyError|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString|TextMetrics"},
yE:{
"^":"Gv;",
...
return a[b]},
q:function(a,b,c){if(!!a.immutable$list)H.Vj(P.f("indexed set"))
...
z.toString
P.L2(null,null,z,a,b)},function(a){return P.Z0(a,null)},null,"$2","$1","SD",2,2,6,22],
...
P.HZ(this,z)},function(a){return this.ZL(a,null)},"yk","$2","$1","gFa",2,2,6,22],
$isb8:1,
...
x=H.J([],[Q.M])
w=H.J([],[Q.M])
y=new Q.V(C.Ns,z,1941,12,44,null,null,null,null,new Q.M(150,285),new Q.M(24,24),new Q.M(900,250),new Q.M(341,175),null,null,y,x,w,C.X)
y.V6(z)
$.P=y
y=H.J(new W.W(window,"keypress",!1),[null])
H.J(new W.xC(0,y.Q,y.a,W.Y(Q.S()),y.b),[H.Z(y,0)]).Y()
y=$.P
P.rb(y.gJ(y))
C.U.gm6(window).ml(Q.QR())},"$0","KW",0,0,1],
pn:[function(a){var z=J.Oq(J.aF(a,$.u0))
$.P.eC(z*0.001)
$.u0=a
C.U.gm6(window).ml(Q.QR())},"$1","QR",2,0,20],
bQ:[function(a){var z=$.P
z.toString
if(J.Zm(a)===113)++z.cy.f
if(a.keyCode===97)--z.cy.f
if(a.keyCode===32)if(z.Q===C.Ns)z.YL()},"$1","S",2,0,21],
N:{
"^":"a;Q,a,b,c,d,h0:e<,WH:f<,r"},
cJ:{
"^":"a;Q,a,b,c,d,e,f"},
cw:{
"^":"a;Q",
X:function(a){return C.r2.p(0,this.Q)}},
V:{
"^":"a;Q,a,b,c,d,e,f,r,x,y,z,ch,cx,cy,db,dx,dy,fr,fx",
wE:[function(a){},"$0","gJ",0,0,1],
eC:function(a){var z,y,x,w,v,u,t,s,r,q,p
for(z=this.dx,y=new J.m1(z,z.length,0,null),x=this.fx,w=this.fr,v=this.dy;y.D();){u=y.c
if(u.gWH()>0){u.f-=a
continue}t=u.e
if(t>=0){t-=a
u.e=t
...
t=t.a
t+=(p-t)*s
q=new Q.M(q+(r.Q-q)*s,t)
u.a=q
r=Math.sin(s*3.141592653589793)
q.a=t-100*(r+Math.sin(s*20)/10)
if(u.e<=0){u.e=0
w.push(u.a)
t=this.cy
t.d+=0.005
t.Q+=0.001
r=t.b+=0.01
t.b=P.u(0,P.C(r,1))}}if(u.r*a/u.d>x.w7()){u.e=0
v.push(u.a)}}C.Nm.PP(z,"removeWhere")
C.Nm.LP(z,new Q.mB(),!0)
if(this.Q===C.NA)if(z.length===0){this.cy.d*=0.7
this.Q=C.Ns}z=this.cy
z.a=-0.001*(z.f+this.d/44*10)
z.c=-0.045454545454545456
this.Am(a)},
Am:function(a){var z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k
z=this.a
y=z.canvas
z.clearRect(0,0,y.width,y.height)
z.fillStyle="rgba(158, 198, 242, 1.0)"
y=z.canvas
...
v=$.an
v.globalAlpha=y.c
v.drawImage(y.Q,0,0,w,x)
z.fillStyle="green"
x=this.y
w=this.z
z.fillRect(x.Q,x.a,w.Q,w.a)
z.fillStyle="red"
w=this.ch
x=this.cx
z.fillRect(w.Q,w.a,x.Q,x.a)
for(z=this.dy,z=new J.m1(z,z.length,0,null);z.D();){u=z.c
y=this.r
x=J.R(u)
w=x.gx(u)
x=x.gy(u)
v=$.an
v.globalAlpha=y.c
v.drawImage(y.Q,w,x,16,16)}for(z=this.fr,z=new J.m1(z,z.length,0,null);z.D();){u=z.c
y=this.x
x=J.R(u)
w=x.gx(u)
x=x.gy(u)
v=$.an
v.globalAlpha=y.c
v.drawImage(y.Q,w,x,16,16)}C.Nm.aN(this.dx,new Q.QC(this))
z=this.db
y=z.Q
y.toString
t=y.getContext("2d")
...
C.Tr.lR(t,w,x/2-v/2,34)
v=y.height
if(typeof v!=="number")return v.R()
r=v*2/3
q=y.width
p=v/3
t.fillStyle="rgba(100, 75, 0, 1)"
t.fillRect(0,r,q,p)
t.fillStyle="rgba(255, 255, 208, 1)"
v=r+5
...
o=y/2-10
n=v+5
m=x/3-1.6666666666666667-5
t.fillStyle="black"
t.font="12px Roboto"
C.Tr.lR(t,"Balloons to create this month: "+C.jn.X(z.a.f),10,n+12)
C.Tr.lR(t,"Balloons ready to launch: "+C.jn.X(z.a.e),10,n+24+5)
t.font="18px Roboto"
x=n+m/2+18
C.Tr.lR(t,"People satisfaction:",10,x)
x+=2
t.fillRect(10,x,o,m)
t.fillStyle="rgba(255, 255, 208, 1)"
x+=2
...
t.fillRect(12,x,v,y)
l=z.a.Q
t.fillStyle="rgba(0, 0, 208, 0.5)"
t.fillRect(12,x,v*l,y)
t.fillStyle="rgba(0, 0, 208, 1.0)"
t.fillRect(12,x,v*(l+z.a.a),y)
x=m*2
n=n+x+2
t.fillStyle="black"
C.Tr.lR(t,"Leader satisfaction: ",10,n)
w=n+9
t.fillRect(10,w,o,m)
t.fillStyle="rgba(255, 255, 208, 1)"
w+=2
t.fillRect(12,w,v,y)
l=z.a.b
t.fillStyle="rgba(0, 208, 0, 0.5)"
t.fillRect(12,w,v*l,y)
t.fillStyle="rgba(0, 208, 0, 1.0)"
t.fillRect(12,w,v*(l+z.a.c),y)
t.fillStyle="black"
k=10+(o+10)
x=r+10+x
C.Tr.lR(t,"Terror level",k,x+2)
x+=10
t.fillRect(k,x,o,m)
t.fillStyle="rgba(255, 255, 208, 1)"
w=k+2
...
t.fillRect(w,x,v,y)
l=z.a.d
t.fillStyle="rgba(208, 0, 0, 0.5)"
t.fillRect(w,x,v*l,y)
t.fillStyle="rgba(208, 0, 0, 1.0)"
t.fillRect(w,x,v*(l*0.8),y)
t.fillStyle="rgba(100, 75, 0, 1)"
t.fillRect(0+o+10+3,r,4,p)},
YL:function(){var z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i
z=this.dx
C.Nm.sv(z,0)
C.Nm.sv(this.dy,0)
C.Nm.sv(this.fr,0)
y=this.cy
if(y.e>0){for(y=this.y,x=this.fx,w=this.z,v=w.Q,u=y.Q,t=this.ch,s=this.cx,r=s.Q,q=t.Q,p=0;o=this.cy,p<o.e;++p){o=x.j1(v)
n=x.j1(w.a)
o=u+o
n=y.a+n
m=x.j1(r)
...
j=x.w7()
i=5+x.w7()*3
j=new Q.N(null,new Q.M(o,n),new Q.M(q+m,k+l),1,i,0,j*0.6,0.1+0.8*(this.d/44))
j.Q=new Q.M(o,n)
j.e=i
z.push(j)}o.e=0
z=o}else z=y
...
if(y>0){z.e=y
z.Q=z.Q+z.a
z.a=0}z=C.jn.V(this.c+1,13)
this.c=z
if(z===0){++z
this.c=z;++this.b}this.db.MW(this.b,z);--this.d
z=this.cy
y=z.b+z.c
z.b=y
z.b=P.u(0,P.C(y,1))
if(this.d===0)P.JS("you lose, months over")
this.Q=C.NA},
V6:function(a){var z,y,x,w,v,u
z=this.a
z.canvas.width=1280
z.canvas.height=720
y=W.jm(720,"img/map2.png",1280)
x=J.R(y)
this.e=new Q.AE(y,x.gN(y),x.gfg(y),1)
w=W.jm(128,"img/balloon4.png",64)
x=J.R(w)
this.f=new Q.AE(w,x.gN(w),x.gfg(w),1)
v=W.jm(64,"img/fail.png",64)
x=J.R(v)
this.r=new Q.AE(v,x.gN(v),x.gfg(v),1)
u=W.jm(64,"img/explosion.png",64)
x=J.R(u)
this.x=new Q.AE(u,x.gN(u),x.gfg(u),1)
$.an=z
x=new Q.cJ(1,0,1,0,0,0,0)
this.cy=x
x=new Q.Sf(z.canvas,x,null,null,"")
this.db=x
x.MW(this.b,this.c)}},
mB:{
"^":"r:2;",
$1:function(a){return a.gh0()<=0}},
QC:{
"^":"r:2;Q",
$1:function(a){var z,y,x,w,v
if(a.gWH()<=0){z=this.Q.f
y=a.a
x=y.a
w=a.c
v=$.an
v.globalAlpha=z.c
v.drawImage(z.Q,y.Q,x,32*w,64*w)}}},
AE:{
"^":"a;Q,a,b,c"},
Sf:{
"^":"a;Q,a,b,c,d",
MW:function(a,b){var z
switch(b){case 1:z="January"
break
case 2:z="February"
break
case 3:z="March"
...
break
default:z="---"
break}this.d=z+" "+C.jn.X(a)}},
M:{
"^":"a;x:Q>,y:a>",
g:function(a,b){return new Q.M(this.Q+J.Rd(b),this.a+b.a)},
T:function(a,b){return new Q.M(this.Q-J.Rd(b),this.a-b.a)},
X:function(a){return H.d(this.Q)+", "+H.d(this.a)}}},1],]
...
C.r2=new H.kz([0,"GameState.WAIT",1,"GameState.FLYING"])
...
init.metadata=[{func:"NT"},{func:"X0",void:true},{func:"aB",args:[null]},{func:"TS",args:[null,P.I]},{func:"uO",args:[P.I]},{func:"cO",args:[{func:"X0",void:true}]},{func:"Vx",void:true,args:[null],opt:[P.Gz]},{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:P.a2},{func:"bb",args:[null,P.Gz]},{func:"N5",void:true,args:[null,P.Gz]},{func:"bh",args:[null,null]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:P.I,args:[P.KN]},{func:"n9",void:true,args:[{func:"X0",void:true}]},{func:"LU",void:true,args:[null]},{func:"Ib",ret:P.a2,args:[null,null]},{func:"bX",ret:P.KN,args:[null]},{func:"E0",ret:P.a2,args:[P.a,P.a]},{func:"ZY",ret:P.KN,args:[P.a]},{func:"Xd",void:true,args:[P.CP]},{func:"Jf",void:true,args:[W.HL]},,];$=null
...
if(typeof dartMainRunner==="function")dartMainRunner(function(b){H.Rq(Q.KW(),b)},[])
else (function(b){H.Rq(Q.KW(),b)})([])})
})()
